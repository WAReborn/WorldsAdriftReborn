namespace WorldsAdriftServer.Objects.CharacterSelection
{
    ...
    {
        public static Dictionary<string, CustomisationSettings.GenderItem> starterHeadItems = new Dictionary<string, CustomisationSettings.GenderItem>
    {
        {
            "hair_bald",
        ...
        public static Dictionary<string, CustomisationSettings.GenderItem> starterFacialHairItems = new Dictionary<string, CustomisationSettings.GenderItem>
    {
        {
            string.Empty,
        ...
        public static Dictionary<string, CustomisationSettings.GenderItem> starterFaceItems = new Dictionary<string, CustomisationSettings.GenderItem>
    {
        {
            "face_A",
        ...
        public static Dictionary<string, CustomisationSettings.GenderItem> starterTorsoItems = new Dictionary<string, CustomisationSettings.GenderItem>
    {
        {
            "torso_wanderer",
        ...
        public static Dictionary<string, CustomisationSettings.GenderItem> starterLegItems = new Dictionary<string, CustomisationSettings.GenderItem>
    {
        {
            "legs_shorts",
        ...
        public static UnityColor[] hairColors = new UnityColor[]
        {
        ...
        public static UnityColor[] skinColors = new UnityColor[]
        {
        ...
        public static UnityColor[] lipColors = new UnityColor[]
        {
        ...
        public static UnityColor[] clothingColors = new UnityColor[]
        {
        ...
        public static string[] allHeads = new string[]
        {
        "Hair_Studded",
        "Hair_Cropped",
        "Hair_Squarefringe",
        ...
        public static string[] allTorsos = new string[]
        {
        "torso_naked",
        "torso_wanderer",
        "torso_ponchoVariantB",
